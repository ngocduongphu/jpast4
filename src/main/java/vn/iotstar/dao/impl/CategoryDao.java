...
public class CategoryDao implements ICategoryDao {
	...
	public Category findByCategoryname(String catename) throws Exception {
		 EntityManager enma = JPAConfig.getEntityManager();
		 String jpql = "SELECT c FROM Categories c WHERE c.Categoryname like :catename";
		...
		public static void main(String[] args) {
			try {
			ICategoryDao userDao = new CategoryDao(); 
...
//			category.setStatus(statuss);
			...
			//userDao.insert(category);
				System.out.println(userDao.findByCategoryname("Iphone"));
			}catch(Exception e) {
				e.printStackTrace();
			}
		}
